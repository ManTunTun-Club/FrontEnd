...
// // ============================================
// // 文件：src/features/Budget/screens/BudgetScreen.js
// // ============================================
// import React, { useState } from 'react';
...
//   const budgetData = BUDGET_DATA[selectedMonth] || BUDGET_DATA['8月'];
//   const currentItems = budgetData[activeTab];
...
//       />
//       <BudgetTabs activeTab={activeTab} onTabChange={setActiveTab} />
//       {currentItems.length > 0 && <BudgetCards items={currentItems} />}
//     </SafeAreaView>
//   );
// };
...
// // // src/features/Budget/screems/BudgetScreen.js //
...
// //       <Text style={{ fontSize:22, fontWeight:'bold' }}>Budget Screen11223</Text>
// //     </View>
// //   );
// // }
